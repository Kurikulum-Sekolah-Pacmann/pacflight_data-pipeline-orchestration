...
-- ON CONFLICT(booking_ticket_id) 
-- DO UPDATE SET
--     book_nk = EXCLUDED.book_nk,
...
--                         final.fct_booking_ticket.book_nk <> EXCLUDED.book_nk
--                         OR final.fct_booking_ticket.book_date_local <> EXCLUDED.book_date_local
...
--                         OR final.fct_booking_ticket.ticket_no <> EXCLUDED.ticket_no
--                         OR final.fct_booking_ticket.passenger_id <> EXCLUDED.passenger_id
--                         OR final.fct_booking_ticket.flight_nk <> EXCLUDED.flight_nk
